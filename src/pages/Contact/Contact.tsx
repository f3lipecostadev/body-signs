...
const Contact: React.FC = () => {
  ...
  const teamMembers: TeamMemberType[] = [
    ...
    { id: '2', name: 'Felipe Costa', role: 'Desenvolvedor', email: 'felipekaua@acad.ifma.edu.br', avatar: 'F' },
    { id: '3', name: 'Alexandre Martins Silva', role: 'Especialista em Libras', email: 'martinsalexandre@acad.ifma.edu.br', avatar: 'A' },
    { id: '4', name: 'João Manoel de Sousa Alves', role: 'Especialista em Libras', email: 'manoel.alves@acad.ifma.edu.br', avatar: 'J' },
    { id: '5', name: 'Kaio Javã Alves Conceição', role: 'Especialista em Libras', email: 'kaiojava@acad.ifma.edu.br', avatar: 'K' },
    { id: '6', name: 'Sthefania de Carla Costa Ferreira', role: 'Especialista em Libras', email: 'sthefaniaferreira@acad.ifma.edu.br', avatar: 'S' }
  ];
      ...
      <section className={styles.teamSection}>
        <div className={styles.teamContainer}>
          <div className={styles.teamHeader}>
            ...
            <p className={styles.teamSubtitle}>As mentes e corações por trás de cada detalhe do Body Signs.</p>
          </div>
