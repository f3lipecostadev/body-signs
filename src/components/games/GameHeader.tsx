    ...
    <header className="mb-[32px] flex flex-wrap items-start justify-between gap-[24px]">
      <div className="flex items-start gap-5">
        <Link
          ...
          className="mt-[6px] flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-full bg-white text-[#111111] shadow-[0_2px_8px_rgba(66,86,150,0.12)] transition hover:-translate-y-[1px]"
        >
          <ArrowLeft size={20} />
        </Link>
